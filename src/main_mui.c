...
ShowAboutDialog (struct AppData *data)
{
  ...
  (CONST_STRPTR) "MUI Interface for Ultimate64/Ultimate-II",
  MUIA_Text_PreParse, (CONST_STRPTR) "\33c", End, Child, VSpace (5), Child,
  TextObject, MUIA_Text_Contents, (CONST_STRPTR) "© 2024 Marcin Spoczynski",
  MUIA_Text_PreParse, (CONST_STRPTR) "\33c", MUIA_Font, MUIV_Font_Tiny, End,
...
main (int argc, char *argv[])
{
  ...
  (CONST_STRPTR)version, MUIA_Application_Copyright, (CONST_STRPTR) "© 2024",
